...
Action.Name = {
    ...
    // TODO (brendan): Change this to EXIT_DELETE_QUESTION_MODE
    CANCEL_DELETE_QUESTION_MODE: 'CANCEL_DELETE_QUESTION_MODE',
    DELETE_QUESTION: 'DELETE_QUESTION',

    ENTER_CREATE_EXAM_MODE: 'ENTER_CREATE_EXAM_MODE',
    CREATE_EXAM: 'CREATE_EXAM',
    CANCEL_CREATE_EXAM: 'CANCEL_CREATE_EXAM',

    // Called when the user tries to cancel
    // an exam that is in process.
    ENTER_CANCEL_TAKE_EXAM_MODE: 'ENTER_CANCEL_TAKE_EXAM_MODE',
    EXIT_CANCEL_TAKE_EXAM_MODE: 'EXIT_CANCEL_TAKE_EXAM_MODE',
